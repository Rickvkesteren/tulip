...
const translations = {
    ...
    de: {
        ...
        heroSubtitle: "Entdecken Sie wunderschöne Blumenzwiebeln aus der Bollenstreek. Wir verbinden Sie direkt mit lokalen Züchtern für beste Qualität.",
        viewCollection: "Kollektion ansehen",
        meetGrowers: "Züchter kennenlernen",
        ...
        shippingEU: "Übriges EU",
        shippingWorldwide: "Weltweit",
        freeFrom: "Kostenlos ab",
        deliveryDays: "Werktage",
        
        // Footer
        footerAbout: "Niederländische Blumenzwiebeln direkt von lokalen Züchtern aus der Bollenstreek in Ihren Garten.",
        allProducts: "Alle Produkte",
        aboutUs: "Über Uns",
        
        // Blog
        blogTitle: "Blog & Pflanztipps",
        blogSubtitle: "Tipps, Tricks und Anleitungen für den Anbau schöner Blumenzwiebeln",
        ...
        filterGrowers: "Blumenzwiebel-Züchter",
        filterExperiences: "Aktivitäten & Erlebnisse",
        filterPlaces: "Orte",
        planRoute: "Route planen",
        
        // Bloom status
        nowBlooming: "Jetzt blühend",
    ...
    fr: {
        ...
        heroSubtitle: "Découvrez les magnifiques bulbes de fleurs de la Bollenstreek. Nous vous connectons directement aux producteurs locaux pour la meilleure qualité.",
        ...
        filterExperiences: "Activités & Expériences",
        filterPlaces: "Lieux",
...
const internationalShipping = {
    ...
    BE: { name: "België", price: 9.95, freeFrom: 75, deliveryDays: "3-5", zone: "benelux" },
    ...
    IT: { name: "Italië", price: 16.95, freeFrom: 125, deliveryDays: "6-8", zone: "eu" },
    ...
    CZ: { name: "Tsjechië", price: 14.95, freeFrom: 100, deliveryDays: "5-7", zone: "eu" },
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (header && !document.querySelector('.language-switcher')) {
        ...
        switcher.innerHTML = `
            <button class="lang-btn ${currentLanguage === 'nl' ? 'active' : ''}" data-lang="nl" onclick="setLanguage('nl')">🇳🇱</button>
